...
<h5 class="alert alert-primary" style="width: 700px;">총 ${totalCount}개의 글이 있습니다</h5>
<table class="table table-bordered" style="width: 700px;">
    <caption align="top"><h4><b>비회원 게시판</b></h4>
        <span style="float: right;font-size: 20px;cursor: pointer;"
              onclick="location.href='./writeform'">
			<i class="bi bi-pencil"></i>글쓰기
		</span>
    </caption>
    <tr style="background-color: #0E6EFD;color: white;">
